...
(function (TG) {
  ...
  */
  TG.CARS = [
    ...
    // ---- añadidos en la v1.4 (modelos de Blender): siempre al final, los pools de las copas usan índices
    {
      id: 'gt3rs', brand: 'Porsche', name: '911 GT3 RS', price: 240000, top: 296, acc: 3.2, hand: 0.9, gears: 7,
      color: '#eef0f3', sec: '#16181c', eng: { cyl: 6, idle: 950, red: 9000, sub: 0.3, turbo: 0 },
      desc: 'El 911 más radical de calle: bóxer atmosférico a 9.000 rpm y un alerón que pega el coche al suelo.',
      rear: { w: 0.95, h: 0.63, deck: 0.44, cabinB: 0.7, cabinT: 0.52, hip: 22, arch: 14, lights: 'bar', spoiler: 'swan', exhaust: 'center2', fins: 5, badge: 'crest', mesh: 1, engine: 2 },
      side: {
        body: [[0.012, 0.064], [0.0, 0.095], [0.008, 0.131], [0.039, 0.144], [0.102, 0.171], [0.164, 0.18], [0.227, 0.182], [0.289, 0.182], [0.352, 0.19], [0.414, 0.24], [0.477, 0.282], [0.539, 0.287], [0.602, 0.283], [0.664, 0.272], [0.727, 0.258], [0.789, 0.241], [0.852, 0.226], [0.914, 0.21], [0.977, 0.193], [0.992, 0.188], [1.0, 0.115], [0.99, 0.046]],
        glass: [[0.417, 0.229], [0.484, 0.269], [0.55, 0.274], [0.617, 0.267], [0.683, 0.255], [0.75, 0.236], [0.816, 0.221], [0.816, 0.206], [0.75, 0.206], [0.683, 0.205], [0.617, 0.201], [0.55, 0.2], [0.484, 0.199], [0.417, 0.198]],
        wheels: [0.217, 0.757, 0.0772], cl: 0.043, rim: '10', caliper: '#e6c000',
        wing: { x: 0.903, y: 0.319, len: 0.172, th: 0.012, post: 0.9, swan: true },
        hl: [[0.006, 0.119], [0.07, 0.132], [0.078, 0.122], [0.014, 0.11]],
        tl: [[0.978, 0.186], [0.998, 0.182], [0.999, 0.164], [0.98, 0.168]],
        line: [[0.06, 0.167], [0.4, 0.176], [0.7, 0.18]], mirror: [0.437, 0.196],
      },
    },
    {
      id: 'gt3r992', brand: 'Porsche', name: '911 GT3 R (992)', price: 520000, top: 290, acc: 3.0, hand: 0.95, gears: 6,
      color: '#d3da22', sec: '#121316', eng: { cyl: 6, idle: 1100, red: 9400, sub: 0.28, turbo: 0 },
      desc: 'El GT3 de carreras de la generación 992: ancho, bajo y hecho para las 24 horas.',
      rear: { w: 0.99, h: 0.62, deck: 0.44, cabinB: 0.7, cabinT: 0.52, hip: 22, arch: 16, lights: 'bar', spoiler: 'swan', exhaust: 'center2', fins: 7, badge: 'crest', mesh: 1, engine: 2 },
      side: {
        body: [[0.012, 0.023], [0.0, 0.075], [0.008, 0.131], [0.039, 0.144], [0.102, 0.171], [0.164, 0.18], [0.227, 0.182], [0.289, 0.182], [0.352, 0.19], [0.414, 0.24], [0.477, 0.282], [0.539, 0.287], [0.602, 0.283], [0.664, 0.272], [0.727, 0.258], [0.789, 0.241], [0.852, 0.226], [0.914, 0.21], [0.977, 0.193], [0.992, 0.188], [1.0, 0.113], [0.99, 0.042]],
        glass: [[0.417, 0.229], [0.484, 0.269], [0.55, 0.274], [0.617, 0.267], [0.683, 0.255], [0.75, 0.236], [0.816, 0.221], [0.816, 0.206], [0.75, 0.206], [0.683, 0.205], [0.617, 0.201], [0.55, 0.2], [0.484, 0.199], [0.417, 0.198]],
        wheels: [0.217, 0.757, 0.0761], cl: 0.039, rim: '10', caliper: '#d0202a',
        wing: { x: 0.901, y: 0.325, len: 0.176, th: 0.012, post: 0.9, swan: true, big: true },
        hl: [[0.006, 0.119], [0.07, 0.131], [0.078, 0.122], [0.014, 0.11]],
        tl: [[0.978, 0.186], [0.998, 0.182], [0.999, 0.164], [0.98, 0.168]],
        line: [[0.06, 0.167], [0.4, 0.176], [0.7, 0.18]], mirror: [0.437, 0.196],
      },
    },
    {
      id: 'gt3r', brand: 'Porsche', name: '911 GT3 R (991.2)', price: 420000, top: 285, acc: 3.1, hand: 0.93, gears: 6,
      color: '#f2f3f5', sec: '#141518', eng: { cyl: 6, idle: 1100, red: 9200, sub: 0.3, turbo: 0 },
      desc: 'La versión de carreras del 991: bóxer atmosférico, alerón enorme y ADN de Le Mans.',
      rear: { w: 0.99, h: 0.62, deck: 0.44, cabinB: 0.7, cabinT: 0.52, hip: 22, arch: 16, lights: 'bar', spoiler: 'bigwing', exhaust: 'twin', fins: 7, badge: 'crest', mesh: 1, engine: 2 },
      side: {
        body: [[0.012, 0.023], [0.0, 0.075], [0.008, 0.131], [0.039, 0.144], [0.102, 0.171], [0.164, 0.18], [0.227, 0.182], [0.289, 0.182], [0.352, 0.19], [0.414, 0.24], [0.477, 0.282], [0.539, 0.287], [0.602, 0.283], [0.664, 0.272], [0.727, 0.258], [0.789, 0.241], [0.852, 0.226], [0.914, 0.21], [0.977, 0.193], [0.992, 0.188], [1.0, 0.113], [0.99, 0.042]],
        glass: [[0.417, 0.229], [0.484, 0.269], [0.55, 0.274], [0.617, 0.267], [0.683, 0.255], [0.75, 0.236], [0.816, 0.221], [0.816, 0.206], [0.75, 0.206], [0.683, 0.205], [0.617, 0.201], [0.55, 0.2], [0.484, 0.199], [0.417, 0.198]],
        wheels: [0.217, 0.757, 0.0761], cl: 0.039, rim: '10', caliper: '#f0c000',
        wing: { x: 0.96, y: 0.29, len: 0.11, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.119], [0.07, 0.131], [0.078, 0.122], [0.014, 0.11]],
        tl: [[0.978, 0.186], [0.998, 0.182], [0.999, 0.164], [0.98, 0.168]],
        line: [[0.06, 0.167], [0.4, 0.176], [0.7, 0.18]], mirror: [0.437, 0.196],
      },
    ...
    {
      id: 'p917', brand: 'Porsche', name: '917K (Gulf)', price: 1500000, top: 360, acc: 2.7, hand: 0.72, gears: 5,
      color: '#8ec9e6', sec: '#f26b1d', eng: { cyl: 12, idle: 1100, red: 8400, sub: 0.3, turbo: 0 },
      desc: 'El Porsche que ganó Le Mans con los colores Gulf. Un flat-12 de 600 CV en una cuña de fibra.',
      rear: { w: 1, h: 0.5, deck: 0.4, cabinB: 0.5, cabinT: 0.36, hip: 8, arch: 4, lights: 'round4', spoiler: 'integrated', exhaust: 'quad', fins: 2, badge: 'crest', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.042], [0.0, 0.06], [0.008, 0.083], [0.039, 0.108], [0.102, 0.155], [0.164, 0.17], [0.227, 0.174], [0.289, 0.185], [0.352, 0.209], [0.414, 0.227], [0.477, 0.227], [0.539, 0.222], [0.602, 0.205], [0.664, 0.187], [0.727, 0.186], [0.789, 0.189], [0.852, 0.188], [0.914, 0.187], [0.977, 0.186], [0.992, 0.21], [1.0, 0.139], [0.99, 0.072]],
        glass: [[0.358, 0.202], [0.401, 0.213], [0.443, 0.215], [0.486, 0.214], [0.528, 0.21], [0.571, 0.202], [0.613, 0.19], [0.613, 0.165], [0.571, 0.164], [0.528, 0.163], [0.486, 0.162], [0.443, 0.16], [0.401, 0.158], [0.358, 0.156]],
        wheels: [0.217, 0.773, 0.0725], cl: 0.045, rim: 'aero', caliper: '#b8b8b8',
        hl: [[0.006, 0.094], [0.07, 0.104], [0.078, 0.097], [0.014, 0.087]],
        tl: [[0.978, 0.174], [0.998, 0.17], [0.999, 0.153], [0.98, 0.157]],
        line: [[0.06, 0.133], [0.4, 0.14], [0.7, 0.143]], mirror: [0.378, 0.153],
      },
    },
    {
      id: 'f40', brand: 'Ferrari', name: 'F40', price: 450000, top: 324, acc: 3.8, hand: 0.7, gears: 5,
      color: '#c8101a', sec: '#16181c', eng: { cyl: 8, idle: 950, red: 7750, sub: 0.35, turbo: 1 },
      desc: 'El último Ferrari que aprobó Enzo: biturbo, sin ayudas y con un carácter salvaje.',
      rear: { w: 0.98, h: 0.56, deck: 0.44, cabinB: 0.58, cabinT: 0.42, hip: 12, arch: 6, lights: 'round4', spoiler: 'wing', exhaust: 'center2', fins: 4, badge: 'horse', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.043], [0.0, 0.069], [0.008, 0.099], [0.039, 0.117], [0.102, 0.149], [0.164, 0.17], [0.227, 0.18], [0.289, 0.183], [0.352, 0.225], [0.414, 0.251], [0.477, 0.258], [0.539, 0.254], [0.602, 0.246], [0.664, 0.236], [0.727, 0.227], [0.789, 0.222], [0.852, 0.221], [0.914, 0.217], [0.977, 0.211], [0.992, 0.21], [1.0, 0.129], [0.99, 0.053]],
        glass: [[0.371, 0.221], [0.422, 0.241], [0.474, 0.245], [0.525, 0.243], [0.577, 0.237], [0.628, 0.23], [0.68, 0.222], [0.68, 0.215], [0.628, 0.212], [0.577, 0.207], [0.525, 0.202], [0.474, 0.199], [0.422, 0.198], [0.371, 0.196]],
        wheels: [0.208, 0.771, 0.0721], cl: 0.044, rim: '5', caliper: '#c41a1a',
        wing: { x: 0.95, y: 0.256, len: 0.096, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.097], [0.07, 0.107], [0.078, 0.1], [0.014, 0.09]],
        tl: [[0.978, 0.2], [0.998, 0.195], [0.999, 0.176], [0.98, 0.18]],
        line: [[0.06, 0.152], [0.4, 0.16], [0.7, 0.163]], mirror: [0.391, 0.194],
      },
    },
    {
      id: 'f296', brand: 'Ferrari', name: '296 GTB Assetto Fiorano', price: 360000, top: 330, acc: 2.9, hand: 0.88, gears: 8,
      color: '#127a66', sec: '#15171b', eng: { cyl: 6, idle: 1000, red: 8500, sub: 0.3, turbo: 1 },
      desc: 'Híbrido enchufable con V6 biturbo y 830 CV, en la versión Assetto Fiorano pensada para el circuito.',
      rear: { w: 0.97, h: 0.58, deck: 0.43, cabinB: 0.6, cabinT: 0.43, hip: 14, arch: 6, lights: 'slim', spoiler: 'active', exhaust: 'center1', fins: 5, badge: 'horse', mesh: 1, engine: 1, stripes: '#f2f3f4' },
      side: {
        body: [[0.012, 0.043], [0.0, 0.067], [0.008, 0.095], [0.039, 0.11], [0.102, 0.136], [0.164, 0.147], [0.227, 0.161], [0.289, 0.174], [0.352, 0.204], [0.414, 0.236], [0.477, 0.261], [0.539, 0.261], [0.602, 0.254], [0.664, 0.241], [0.727, 0.224], [0.789, 0.211], [0.852, 0.203], [0.914, 0.194], [0.977, 0.189], [0.992, 0.187], [1.0, 0.115], [0.99, 0.047]],
        glass: [[0.386, 0.207], [0.455, 0.242], [0.524, 0.248], [0.594, 0.241], [0.663, 0.227], [0.732, 0.209], [0.802, 0.197], [0.802, 0.193], [0.732, 0.193], [0.663, 0.193], [0.594, 0.191], [0.524, 0.189], [0.455, 0.188], [0.386, 0.186]],
        wheels: [0.2, 0.774, 0.0737], cl: 0.043, rim: '10', caliper: '#f2c400',
        hl: [[0.006, 0.091], [0.07, 0.1], [0.078, 0.093], [0.014, 0.084]],
        tl: [[0.978, 0.179], [0.998, 0.175], [0.999, 0.158], [0.98, 0.161]],
        line: [[0.06, 0.154], [0.4, 0.162], [0.7, 0.166]], mirror: [0.406, 0.184],
      },
    },
    {
      id: 'f296gt3', brand: 'Ferrari', name: '296 GT3', price: 600000, top: 300, acc: 3.0, hand: 0.95, gears: 6,
      color: '#d10a0a', sec: '#15171b', eng: { cyl: 6, idle: 1100, red: 8500, sub: 0.28, turbo: 1 },
      desc: 'El 296 convertido en coche de carreras GT3: más ancho, más bajo y con un alerón gigante.',
      rear: { w: 1, h: 0.57, deck: 0.43, cabinB: 0.6, cabinT: 0.43, hip: 14, arch: 8, lights: 'slim', spoiler: 'swan', exhaust: 'center2', fins: 7, badge: 'horse', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.023], [0.0, 0.057], [0.008, 0.095], [0.039, 0.11], [0.102, 0.136], [0.164, 0.146], [0.227, 0.165], [0.289, 0.174], [0.352, 0.204], [0.414, 0.236], [0.477, 0.261], [0.539, 0.261], [0.602, 0.254], [0.664, 0.239], [0.727, 0.222], [0.789, 0.21], [0.852, 0.202], [0.914, 0.193], [0.977, 0.19], [0.992, 0.187], [1.0, 0.112], [0.99, 0.041]],
        glass: [[0.386, 0.207], [0.455, 0.242], [0.524, 0.248], [0.594, 0.241], [0.663, 0.227], [0.732, 0.209], [0.802, 0.197], [0.802, 0.193], [0.732, 0.193], [0.663, 0.193], [0.594, 0.191], [0.524, 0.189], [0.455, 0.188], [0.386, 0.186]],
        wheels: [0.2, 0.774, 0.0748], cl: 0.038, rim: '5', caliper: '#d0d0d0',
        wing: { x: 0.905, y: 0.313, len: 0.178, th: 0.012, post: 0.9, swan: true, big: true },
        hl: [[0.006, 0.091], [0.07, 0.1], [0.078, 0.093], [0.014, 0.084]],
        tl: [[0.978, 0.179], [0.998, 0.175], [0.999, 0.158], [0.98, 0.161]],
        line: [[0.06, 0.154], [0.4, 0.162], [0.7, 0.165]], mirror: [0.406, 0.184],
      },
    },
    {
      id: 'sp3', brand: 'Ferrari', name: 'Daytona SP3', price: 950000, top: 340, acc: 2.85, hand: 0.88, gears: 7,
      color: '#b8101c', sec: '#141518', eng: { cyl: 12, idle: 1000, red: 9500, sub: 0.28, turbo: 0 },
      desc: 'Serie Icona: el V12 atmosférico más potente de Ferrari con la trasera de lamas de los prototipos de los 60.',
      rear: { w: 1, h: 0.54, deck: 0.42, cabinB: 0.58, cabinT: 0.42, hip: 16, arch: 4, lights: 'slim', spoiler: 'lip', exhaust: 'center2', fins: 6, badge: 'horse', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.041], [0.0, 0.059], [0.008, 0.081], [0.039, 0.095], [0.102, 0.136], [0.164, 0.153], [0.227, 0.161], [0.289, 0.162], [0.352, 0.165], [0.414, 0.206], [0.477, 0.234], [0.539, 0.237], [0.602, 0.23], [0.664, 0.219], [0.727, 0.206], [0.789, 0.195], [0.852, 0.187], [0.914, 0.183], [0.977, 0.18], [0.992, 0.178], [1.0, 0.109], [0.99, 0.045]],
        glass: [[0.411, 0.193], [0.477, 0.221], [0.543, 0.225], [0.609, 0.216], [0.676, 0.205], [0.742, 0.191], [0.808, 0.182], [0.808, 0.183], [0.742, 0.183], [0.676, 0.181], [0.609, 0.179], [0.543, 0.177], [0.477, 0.175], [0.411, 0.173]],
        wheels: [0.211, 0.775, 0.0683], cl: 0.043, rim: '5', caliper: '#f2c400',
        hl: [[0.006, 0.078], [0.07, 0.086], [0.078, 0.08], [0.014, 0.072]],
        tl: [[0.978, 0.17], [0.998, 0.167], [0.999, 0.15], [0.98, 0.154]],
        line: [[0.06, 0.139], [0.4, 0.146], [0.7, 0.149]], mirror: [0.431, 0.171],
      },
    },
    {
      id: 'f499p', brand: 'Ferrari', name: '499P', price: 1800000, top: 340, acc: 2.7, hand: 0.97, gears: 7,
      color: '#c8101a', sec: '#1b1c1f', eng: { cyl: 6, idle: 1100, red: 9000, sub: 0.25, turbo: 1 },
      desc: 'El prototipo que devolvió a Ferrari la victoria absoluta en Le Mans cincuenta años después.',
      rear: { w: 1, h: 0.5, deck: 0.36, cabinB: 0.42, cabinT: 0.3, hip: 6, arch: 0, lights: 'bar', spoiler: 'bigwing', exhaust: 'center1', fins: 8, badge: 'horse', mesh: 1, engine: 0, fin: 1 },
      side: {
        body: [[0.012, 0.019], [0.0, 0.052], [0.008, 0.09], [0.039, 0.133], [0.102, 0.159], [0.164, 0.167], [0.227, 0.166], [0.289, 0.156], [0.352, 0.193], [0.414, 0.208], [0.477, 0.212], [0.539, 0.21], [0.602, 0.204], [0.664, 0.196], [0.727, 0.184], [0.789, 0.181], [0.852, 0.18], [0.914, 0.176], [0.977, 0.171], [0.992, 0.17], [1.0, 0.109], [0.99, 0.052]],
        glass: [[0.375, 0.188], [0.432, 0.199], [0.488, 0.202], [0.545, 0.199], [0.601, 0.194], [0.658, 0.187], [0.714, 0.177], [0.714, 0.158], [0.658, 0.158], [0.601, 0.158], [0.545, 0.158], [0.488, 0.158], [0.432, 0.157], [0.375, 0.154]],
        wheels: [0.195, 0.796, 0.0711], cl: 0.039, rim: '10', caliper: '#c41a1a',
        wing: { x: 0.958, y: 0.214, len: 0.088, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.11], [0.07, 0.122], [0.078, 0.113], [0.014, 0.102]],
        tl: [[0.978, 0.161], [0.998, 0.158], [0.999, 0.142], [0.98, 0.146]],
        line: [[0.06, 0.125], [0.4, 0.131], [0.7, 0.134]], mirror: [0.395, 0.152],
      },
    },
    {
      id: 'testarossa', brand: 'Ferrari', name: '250 Testa Rossa', price: 1200000, top: 270, acc: 6.0, hand: 0.55, gears: 4,
      color: '#8d1417', sec: '#18191c', eng: { cyl: 12, idle: 900, red: 7200, sub: 0.4, turbo: 0 },
      desc: 'Pontones, parrilla oval y un V12 Colombo: la barchetta que dominó las carreras de los años 50.',
      rear: { w: 0.82, h: 0.55, deck: 0.45, cabinB: 0.5, cabinT: 0.4, hip: 10, arch: 8, lights: 'round4', exhaust: 'twin', fins: 0, badge: 'horse', mesh: 0, engine: 0 },
      side: {
        body: [[0.012, 0.067], [0.0, 0.097], [0.008, 0.131], [0.039, 0.159], [0.102, 0.166], [0.164, 0.173], [0.227, 0.173], [0.289, 0.168], [0.352, 0.222], [0.414, 0.167], [0.477, 0.169], [0.539, 0.197], [0.602, 0.229], [0.664, 0.187], [0.727, 0.192], [0.789, 0.193], [0.852, 0.192], [0.914, 0.191], [0.977, 0.191], [0.992, 0.189], [1.0, 0.129], [0.99, 0.075]],
        wheels: [0.209, 0.772, 0.0827], cl: 0.058, rim: '10', caliper: '#3a3a3c',
        hl: [[0.006, 0.122], [0.07, 0.135], [0.078, 0.125], [0.014, 0.113]],
        tl: [[0.978, 0.177], [0.998, 0.174], [0.999, 0.156], [0.98, 0.16]],
        line: [[0.06, 0.1], [0.4, 0.106], [0.7, 0.108]],
      },
    },
    {
      id: 'huracanspy', brand: 'Lamborghini', name: 'Huracán EVO Spyder', price: 260000, top: 325, acc: 3.1, hand: 0.8, gears: 7,
      color: '#1d8fd1', sec: '#141518', eng: { cyl: 10, idle: 1000, red: 8500, sub: 0.32, turbo: 0 },
      desc: 'El V10 a cielo abierto: el Huracán EVO con capota de lona y el mismo grito a 8.500 rpm.',
      rear: { w: 0.98, h: 0.56, deck: 0.42, cabinB: 0.6, cabinT: 0.42, hip: 12, arch: 4, lights: 'y', spoiler: 'lip', exhaust: 'high2', fins: 5, badge: 'bull', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.042], [0.0, 0.069], [0.008, 0.1], [0.039, 0.113], [0.102, 0.138], [0.164, 0.153], [0.227, 0.165], [0.289, 0.183], [0.352, 0.218], [0.414, 0.249], [0.477, 0.257], [0.539, 0.257], [0.602, 0.249], [0.664, 0.241], [0.727, 0.232], [0.789, 0.223], [0.852, 0.214], [0.914, 0.206], [0.977, 0.204], [0.992, 0.203], [1.0, 0.124], [0.99, 0.049]],
        glass: [[0.372, 0.213], [0.443, 0.241], [0.514, 0.244], [0.585, 0.237], [0.656, 0.23], [0.727, 0.221], [0.798, 0.211], [0.798, 0.201], [0.727, 0.201], [0.656, 0.2], [0.585, 0.199], [0.514, 0.197], [0.443, 0.196], [0.372, 0.196]],
        wheels: [0.228, 0.808, 0.0739], cl: 0.044, rim: 'Y', caliper: '#e8c200',
        hl: [[0.006, 0.092], [0.07, 0.101], [0.078, 0.094], [0.014, 0.085]],
        tl: [[0.978, 0.192], [0.998, 0.188], [0.999, 0.169], [0.98, 0.173]],
        line: [[0.06, 0.152], [0.4, 0.16], [0.7, 0.163]], mirror: [0.392, 0.193],
      },
    },
    {
      id: 'huracanst', brand: 'Lamborghini', name: 'Huracán Super Trofeo EVO2', price: 480000, top: 290, acc: 3.0, hand: 0.93, gears: 6,
      color: '#8a9278', sec: '#16181b', eng: { cyl: 10, idle: 1100, red: 8700, sub: 0.3, turbo: 0 },
      desc: 'El coche de la copa monomarca de Lamborghini: V10 atmosférico, toma en el techo y alerón de carreras.',
      rear: { w: 1, h: 0.55, deck: 0.42, cabinB: 0.6, cabinT: 0.42, hip: 12, arch: 6, lights: 'y', spoiler: 'bigwing', exhaust: 'high2', fins: 7, badge: 'bull', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.024], [0.0, 0.06], [0.008, 0.1], [0.039, 0.113], [0.102, 0.138], [0.164, 0.153], [0.227, 0.165], [0.289, 0.183], [0.352, 0.218], [0.414, 0.249], [0.477, 0.257], [0.539, 0.257], [0.602, 0.277], [0.664, 0.241], [0.727, 0.232], [0.789, 0.223], [0.852, 0.214], [0.914, 0.206], [0.977, 0.204], [0.992, 0.204], [1.0, 0.122], [0.99, 0.044]],
        glass: [[0.372, 0.213], [0.443, 0.241], [0.514, 0.244], [0.585, 0.237], [0.656, 0.23], [0.727, 0.221], [0.798, 0.211], [0.798, 0.201], [0.727, 0.201], [0.656, 0.2], [0.585, 0.199], [0.514, 0.197], [0.443, 0.196], [0.372, 0.196]],
        wheels: [0.228, 0.808, 0.0752], cl: 0.04, rim: '10', caliper: '#ff7a1a',
        wing: { x: 0.954, y: 0.299, len: 0.106, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.092], [0.07, 0.101], [0.078, 0.094], [0.014, 0.085]],
        tl: [[0.978, 0.192], [0.998, 0.188], [0.999, 0.169], [0.98, 0.173]],
        line: [[0.06, 0.152], [0.4, 0.16], [0.7, 0.163]], mirror: [0.392, 0.193],
      },
    ...
    {
      id: 'quattro', brand: 'Audi', name: 'Sport Quattro S1 E2', price: 180000, top: 220, acc: 3.1, hand: 0.78, gears: 6,
      color: '#f4f4f2', sec: '#f4b400', eng: { cyl: 6, idle: 1000, red: 8000, sub: 0.4, turbo: 1 },
      desc: 'La leyenda del Grupo B: cinco cilindros turbo, tracción quattro y un alerón imposible.',
      rear: { w: 0.95, h: 0.7, deck: 0.5, cabinB: 0.76, cabinT: 0.6, hip: 4, arch: 10, lights: 'bar', spoiler: 'bigwing', exhaust: 'single', fins: 0, badge: 'rings', mesh: 0, engine: 0 },
      side: {
        body: [[0.012, 0.042], [0.0, 0.107], [0.008, 0.177], [0.039, 0.188], [0.102, 0.199], [0.164, 0.206], [0.227, 0.213], [0.289, 0.216], [0.352, 0.234], [0.414, 0.301], [0.477, 0.32], [0.539, 0.322], [0.602, 0.322], [0.664, 0.322], [0.727, 0.321], [0.789, 0.291], [0.852, 0.236], [0.914, 0.223], [0.977, 0.222], [0.992, 0.222], [1.0, 0.144], [0.99, 0.072]],
        glass: [[0.405, 0.284], [0.462, 0.304], [0.519, 0.309], [0.576, 0.309], [0.634, 0.309], [0.691, 0.309], [0.748, 0.305], [0.748, 0.227], [0.691, 0.228], [0.634, 0.228], [0.576, 0.228], [0.519, 0.228], [0.462, 0.228], [0.405, 0.226]],
        wheels: [0.252, 0.786, 0.0745], cl: 0.056, rim: '6', caliper: '#c41a1a',
        wing: { x: 0.947, y: 0.277, len: 0.111, th: 0.012, post: 0.9 },
        hl: [[0.006, 0.149], [0.07, 0.164], [0.078, 0.153], [0.014, 0.138]],
        tl: [[0.978, 0.207], [0.998, 0.202], [0.999, 0.182], [0.98, 0.187]],
        line: [[0.06, 0.189], [0.4, 0.199], [0.7, 0.203]], mirror: [0.425, 0.223],
      },
    },
    {
      id: 'delta', brand: 'Lancia', name: 'Delta HF Integrale Evo', price: 70000, top: 220, acc: 5.7, hand: 0.75, gears: 5,
      color: '#f4f4f2', sec: '#1a2a6c', eng: { cyl: 4, idle: 900, red: 6500, sub: 0.4, turbo: 1 },
      desc: 'Seis títulos mundiales de rally seguidos: turbo, tracción total y la librea Martini.',
      rear: { w: 0.93, h: 0.72, deck: 0.52, cabinB: 0.78, cabinT: 0.62, hip: 4, arch: 10, lights: 'slim', spoiler: 'lip', exhaust: 'single', fins: 0, badge: 'shield', mesh: 0, engine: 0 },
      side: {
        body: [[0.012, 0.045], [0.0, 0.118], [0.008, 0.196], [0.039, 0.206], [0.102, 0.214], [0.164, 0.227], [0.227, 0.233], [0.289, 0.235], [0.352, 0.276], [0.414, 0.331], [0.477, 0.348], [0.539, 0.35], [0.602, 0.35], [0.664, 0.35], [0.727, 0.35], [0.789, 0.35], [0.852, 0.348], [0.914, 0.309], [0.977, 0.25], [0.992, 0.249], [1.0, 0.157], [0.99, 0.071]],
        glass: [[0.394, 0.308], [0.464, 0.332], [0.533, 0.336], [0.603, 0.336], [0.672, 0.336], [0.741, 0.336], [0.811, 0.336], [0.811, 0.244], [0.741, 0.245], [0.672, 0.246], [0.603, 0.246], [0.533, 0.246], [0.464, 0.246], [0.394, 0.243]],
        wheels: [0.205, 0.841, 0.0769], cl: 0.056, rim: '10', caliper: '#c41a1a',
        wing: { x: 0.862, y: 0.353, len: 0.077, th: 0.012, post: 0.9 },
        hl: [[0.006, 0.162], [0.07, 0.178], [0.078, 0.166], [0.014, 0.149]],
        tl: [[0.978, 0.246], [0.998, 0.24], [0.999, 0.217], [0.98, 0.222]],
        line: [[0.06, 0.206], [0.4, 0.217], [0.7, 0.221]], mirror: [0.414, 0.24],
      },
    },
    {
      id: 'polowrc', brand: 'Volkswagen', name: 'Polo R WRC', price: 140000, top: 200, acc: 3.9, hand: 0.85, gears: 6,
      color: '#1c2f7a', sec: '#d6202a', eng: { cyl: 4, idle: 1100, red: 7500, sub: 0.35, turbo: 1 },
      desc: 'Cuatro títulos mundiales de rally seguidos: 1.6 turbo de 318 CV y tracción total.',
      rear: { w: 0.97, h: 0.72, deck: 0.52, cabinB: 0.78, cabinT: 0.62, hip: 4, arch: 12, lights: 'slim', spoiler: 'wing', exhaust: 'single', fins: 0, badge: 'ring', mesh: 1, engine: 0 },
      side: {
        body: [[0.012, 0.045], [0.0, 0.11], [0.008, 0.18], [0.039, 0.195], [0.102, 0.212], [0.164, 0.223], [0.227, 0.228], [0.289, 0.231], [0.352, 0.251], [0.414, 0.33], [0.477, 0.347], [0.539, 0.349], [0.602, 0.349], [0.664, 0.349], [0.727, 0.349], [0.789, 0.349], [0.852, 0.347], [0.914, 0.312], [0.977, 0.25], [0.992, 0.249], [1.0, 0.157], [0.99, 0.07]],
        glass: [[0.396, 0.307], [0.464, 0.332], [0.532, 0.335], [0.601, 0.335], [0.669, 0.335], [0.737, 0.335], [0.805, 0.335], [0.805, 0.242], [0.737, 0.243], [0.669, 0.243], [0.601, 0.244], [0.532, 0.244], [0.464, 0.243], [0.396, 0.24]],
        wheels: [0.214, 0.834, 0.0817], cl: 0.058, rim: '6', caliper: '#c41a1a',
        wing: { x: 0.867, y: 0.355, len: 0.101, th: 0.012, post: 0.9 },
        hl: [[0.006, 0.156], [0.07, 0.172], [0.078, 0.16], [0.014, 0.144]],
        tl: [[0.978, 0.233], [0.998, 0.228], [0.999, 0.205], [0.98, 0.21]],
        line: [[0.06, 0.206], [0.4, 0.216], [0.7, 0.221]], mirror: [0.416, 0.238],
      },
    },
    {
      id: 'i20wrc', brand: 'Hyundai', name: 'i20 WRC', price: 130000, top: 200, acc: 3.9, hand: 0.84, gears: 6,
      color: '#8c9bb1', sec: '#1b2a4a', eng: { cyl: 4, idle: 1100, red: 7500, sub: 0.35, turbo: 1 },
      desc: 'El i20 del Mundial de Rally: compacto, ligero y con un alerón de techo enorme.',
      rear: { w: 0.97, h: 0.72, deck: 0.52, cabinB: 0.78, cabinT: 0.62, hip: 4, arch: 12, lights: 'slim', spoiler: 'wing', exhaust: 'single', fins: 0, badge: 'ring', mesh: 1, engine: 0 },
      side: {
        body: [[0.012, 0.043], [0.0, 0.107], [0.008, 0.176], [0.039, 0.19], [0.102, 0.208], [0.164, 0.218], [0.227, 0.223], [0.289, 0.225], [0.352, 0.264], [0.414, 0.327], [0.477, 0.34], [0.539, 0.341], [0.602, 0.341], [0.664, 0.341], [0.727, 0.341], [0.789, 0.341], [0.852, 0.339], [0.914, 0.305], [0.977, 0.242], [0.992, 0.242], [1.0, 0.153], [0.99, 0.068]],
        glass: [[0.393, 0.301], [0.461, 0.325], [0.529, 0.328], [0.597, 0.328], [0.665, 0.328], [0.733, 0.328], [0.801, 0.328], [0.801, 0.235], [0.733, 0.235], [0.665, 0.236], [0.597, 0.236], [0.529, 0.237], [0.461, 0.236], [0.393, 0.233]],
        wheels: [0.207, 0.834, 0.0793], cl: 0.056, rim: '6', caliper: '#1b1c1f',
        wing: { x: 0.868, y: 0.348, len: 0.102, th: 0.012, post: 0.9 },
        hl: [[0.006, 0.153], [0.07, 0.169], [0.078, 0.157], [0.014, 0.141]],
        tl: [[0.978, 0.226], [0.998, 0.221], [0.999, 0.199], [0.98, 0.204]],
        line: [[0.06, 0.201], [0.4, 0.212], [0.7, 0.216]], mirror: [0.413, 0.231],
      },
    },
    {
      id: 'beetle', brand: 'Volkswagen', name: 'Beetle Gr.3', price: 160000, top: 270, acc: 3.5, hand: 0.86, gears: 6,
      color: '#f2f3f5', sec: '#5b3fd0', eng: { cyl: 4, idle: 1000, red: 7800, sub: 0.35, turbo: 1 },
      desc: 'El Escarabajo como nunca lo viste: carrocería de GT, aletas anchas y un gran alerón.',
      rear: { w: 1, h: 0.62, deck: 0.45, cabinB: 0.66, cabinT: 0.48, hip: 14, arch: 12, lights: 'round2', spoiler: 'swan', exhaust: 'center2', fins: 6, badge: 'ring', mesh: 1, engine: 0 },
      side: {
        body: [[0.012, 0.023], [0.0, 0.082], [0.008, 0.147], [0.039, 0.159], [0.102, 0.178], [0.164, 0.187], [0.227, 0.194], [0.289, 0.197], [0.352, 0.201], [0.414, 0.238], [0.477, 0.28], [0.539, 0.293], [0.602, 0.3], [0.664, 0.298], [0.727, 0.268], [0.789, 0.251], [0.852, 0.233], [0.914, 0.209], [0.977, 0.196], [0.992, 0.196], [1.0, 0.117], [0.99, 0.043]],
        glass: [[0.471, 0.265], [0.528, 0.28], [0.585, 0.287], [0.642, 0.287], [0.699, 0.271], [0.756, 0.246], [0.812, 0.231], [0.812, 0.209], [0.756, 0.21], [0.699, 0.211], [0.642, 0.211], [0.585, 0.211], [0.528, 0.211], [0.471, 0.211]],
        wheels: [0.227, 0.805, 0.0784], cl: 0.047, rim: '5', caliper: '#c41a1a',
        wing: { x: 0.936, y: 0.295, len: 0.15, th: 0.012, post: 0.9, swan: true, big: true },
        hl: [[0.006, 0.13], [0.07, 0.143], [0.078, 0.133], [0.014, 0.12]],
        tl: [[0.978, 0.182], [0.998, 0.179], [0.999, 0.161], [0.98, 0.165]],
        line: [[0.06, 0.167], [0.4, 0.176], [0.7, 0.179]], mirror: [0.491, 0.208],
      },
    },
    {
      id: 'bolide', brand: 'Bugatti', name: 'Bolide', price: 1900000, top: 380, acc: 2.2, hand: 0.96, gears: 7,
      color: '#2a8fd8', sec: '#16181c', eng: { cyl: 16, idle: 900, red: 7000, sub: 0.4, turbo: 1 },
      desc: 'El Bugatti de circuito: W16 de 1.850 CV en un coche de 1.450 kg. Solo para la pista.',
      rear: { w: 1, h: 0.5, deck: 0.38, cabinB: 0.44, cabinT: 0.32, hip: 10, arch: 4, lights: 'round2', spoiler: 'bigwing', exhaust: 'center2', fins: 7, badge: 'macaron', mesh: 1, engine: 0, fin: 1 },
      side: {
        body: [[0.012, 0.032], [0.0, 0.055], [0.008, 0.082], [0.039, 0.101], [0.102, 0.142], [0.164, 0.156], [0.227, 0.16], [0.289, 0.158], [0.352, 0.177], [0.414, 0.202], [0.477, 0.209], [0.539, 0.209], [0.602, 0.204], [0.664, 0.195], [0.727, 0.183], [0.789, 0.17], [0.852, 0.17], [0.914, 0.169], [0.977, 0.166], [0.992, 0.166], [1.0, 0.101], [0.99, 0.04]],
        glass: [[0.395, 0.183], [0.449, 0.196], [0.503, 0.199], [0.556, 0.196], [0.61, 0.191], [0.663, 0.183], [0.717, 0.174], [0.717, 0.159], [0.663, 0.158], [0.61, 0.156], [0.556, 0.155], [0.503, 0.154], [0.449, 0.152], [0.395, 0.151]],
        wheels: [0.216, 0.794, 0.0715], cl: 0.04, rim: 'turbine', caliper: '#2a8fd8',
        wing: { x: 0.956, y: 0.225, len: 0.093, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.084], [0.07, 0.093], [0.078, 0.086], [0.014, 0.078]],
        tl: [[0.978, 0.156], [0.998, 0.153], [0.999, 0.138], [0.98, 0.141]],
        line: [[0.06, 0.123], [0.4, 0.13], [0.7, 0.133]], mirror: [0.415, 0.149],
      },
    },
    {
      id: 'gtp', brand: 'Cadillac', name: 'V-Series.R (GTP)', price: 1400000, top: 330, acc: 2.8, hand: 0.96, gears: 7,
      color: '#17181b', sec: '#c9a13b', eng: { cyl: 8, idle: 1000, red: 8500, sub: 0.35, turbo: 0 },
      desc: 'El prototipo LMDh de Cadillac: V8 atmosférico híbrido y los faros en cuchilla vertical.',
      rear: { w: 1, h: 0.5, deck: 0.36, cabinB: 0.42, cabinT: 0.3, hip: 6, arch: 0, lights: 'bar', spoiler: 'bigwing', exhaust: 'center1', fins: 8, badge: 'crest', mesh: 1, engine: 0, fin: 1 },
      side: {
        body: [[0.012, 0.019], [0.0, 0.052], [0.008, 0.089], [0.039, 0.133], [0.102, 0.158], [0.164, 0.167], [0.227, 0.166], [0.289, 0.156], [0.352, 0.193], [0.414, 0.208], [0.477, 0.212], [0.539, 0.21], [0.602, 0.204], [0.664, 0.196], [0.727, 0.184], [0.789, 0.181], [0.852, 0.18], [0.914, 0.176], [0.977, 0.171], [0.992, 0.17], [1.0, 0.109], [0.99, 0.052]],
        glass: [[0.375, 0.188], [0.432, 0.199], [0.488, 0.202], [0.545, 0.199], [0.601, 0.194], [0.658, 0.187], [0.714, 0.177], [0.714, 0.158], [0.658, 0.158], [0.601, 0.158], [0.545, 0.158], [0.488, 0.158], [0.432, 0.157], [0.375, 0.154]],
        wheels: [0.195, 0.796, 0.0711], cl: 0.039, rim: '10', caliper: '#c9a13b',
        wing: { x: 0.958, y: 0.214, len: 0.088, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.11], [0.07, 0.121], [0.078, 0.113], [0.014, 0.101]],
        tl: [[0.978, 0.161], [0.998, 0.158], [0.999, 0.142], [0.98, 0.146]],
        line: [[0.06, 0.125], [0.4, 0.131], [0.7, 0.134]], mirror: [0.395, 0.152],
      },
    },
    {
      id: 'devel', brand: 'Devel', name: 'Sixteen', price: 1600000, top: 420, acc: 2.5, hand: 0.78, gears: 7,
      color: '#eceef1', sec: '#141518', eng: { cyl: 16, idle: 900, red: 7200, sub: 0.45, turbo: 1 },
      desc: 'El hiperdeportivo de Dubái con alma de caza de combate y un V16 de potencia de récord.',
      rear: { w: 1, h: 0.56, deck: 0.43, cabinB: 0.58, cabinT: 0.42, hip: 16, arch: 6, lights: 'slim', spoiler: 'wing', exhaust: 'quad', fins: 6, badge: 'shield', mesh: 1, engine: 0, fin: 1 },
      side: {
        body: [[0.012, 0.037], [0.0, 0.059], [0.008, 0.085], [0.039, 0.111], [0.102, 0.159], [0.164, 0.178], [0.227, 0.184], [0.289, 0.18], [0.352, 0.211], [0.414, 0.239], [0.477, 0.247], [0.539, 0.247], [0.602, 0.242], [0.664, 0.231], [0.727, 0.215], [0.789, 0.202], [0.852, 0.196], [0.914, 0.19], [0.977, 0.258], [0.992, 0.182], [1.0, 0.109], [0.99, 0.039]],
        glass: [[0.371, 0.21], [0.435, 0.231], [0.498, 0.237], [0.562, 0.234], [0.626, 0.226], [0.69, 0.214], [0.754, 0.201], [0.754, 0.186], [0.69, 0.186], [0.626, 0.184], [0.562, 0.182], [0.498, 0.18], [0.435, 0.178], [0.371, 0.175]],
        wheels: [0.228, 0.813, 0.0727], cl: 0.041, rim: '5', caliper: '#c41a1a',
        wing: { x: 0.953, y: 0.246, len: 0.069, th: 0.012, post: 0.9 },
        hl: [[0.006, 0.09], [0.07, 0.099], [0.078, 0.092], [0.014, 0.083]],
        tl: [[0.978, 0.174], [0.998, 0.17], [0.999, 0.154], [0.98, 0.157]],
        line: [[0.06, 0.146], [0.4, 0.154], [0.7, 0.157]], mirror: [0.391, 0.173],
      },
    },
    {
      id: 'charger', brand: 'Dodge', name: 'Charger R/T 1970', price: 45000, top: 240, acc: 4.0, hand: 0.45, gears: 4,
      color: '#18191c', sec: '#101113', eng: { cyl: 8, idle: 750, red: 6500, sub: 0.6, turbo: 1 },
      desc: 'Muscle car con el compresor asomando del capó. Un cuarto de milla y nada más.',
      rear: { w: 0.95, h: 0.64, deck: 0.47, cabinB: 0.72, cabinT: 0.56, hip: 6, arch: 4, lights: 'bar', exhaust: 'twin', fins: 0, badge: 'crest', mesh: 0, engine: 0 },
      side: {
        body: [[0.012, 0.054], [0.0, 0.106], [0.008, 0.161], [0.039, 0.163], [0.102, 0.164], [0.164, 0.166], [0.227, 0.168], [0.289, 0.169], [0.352, 0.223], [0.414, 0.182], [0.477, 0.234], [0.539, 0.255], [0.602, 0.256], [0.664, 0.255], [0.727, 0.237], [0.789, 0.192], [0.852, 0.174], [0.914, 0.173], [0.977, 0.171], [0.992, 0.17], [1.0, 0.111], [0.99, 0.056]],
        glass: [[0.462, 0.213], [0.507, 0.238], [0.552, 0.245], [0.597, 0.245], [0.642, 0.245], [0.687, 0.241], [0.732, 0.223], [0.732, 0.179], [0.687, 0.18], [0.642, 0.18], [0.597, 0.179], [0.552, 0.179], [0.507, 0.178], [0.462, 0.177]],
        wheels: [0.222, 0.784, 0.0644], cl: 0.055, rim: '5', caliper: '#3a3a3c',
        hl: [[0.006, 0.127], [0.07, 0.14], [0.078, 0.13], [0.014, 0.117]],
        tl: [[0.978, 0.16], [0.998, 0.156], [0.999, 0.141], [0.98, 0.144]],
        line: [[0.06, 0.144], [0.4, 0.152], [0.7, 0.155]], mirror: [0.482, 0.176],
      },
    },
    {
      id: 'clkgtr', brand: 'Mercedes-Benz', name: 'CLK GTR Roadster', price: 1100000, top: 320, acc: 3.8, hand: 0.8, gears: 6,
      color: '#c0c4ca', sec: '#16181c', eng: { cyl: 12, idle: 900, red: 7000, sub: 0.35, turbo: 0 },
      desc: 'Un GT1 de carreras con matrícula y sin techo: V12 de 6.9 litros y solo seis unidades.',
      rear: { w: 0.97, h: 0.56, deck: 0.43, cabinB: 0.5, cabinT: 0.4, hip: 12, arch: 6, lights: 'slim', spoiler: 'wing', exhaust: 'center2', fins: 5, badge: 'star', mesh: 1, engine: 0 },
      side: {
        body: [[0.012, 0.036], [0.0, 0.062], [0.008, 0.092], [0.039, 0.113], [0.102, 0.145], [0.164, 0.157], [0.227, 0.163], [0.289, 0.163], [0.352, 0.16], [0.414, 0.204], [0.477, 0.186], [0.539, 0.16], [0.602, 0.162], [0.664, 0.214], [0.727, 0.173], [0.789, 0.176], [0.852, 0.175], [0.914, 0.175], [0.977, 0.172], [0.992, 0.172], [1.0, 0.105], [0.99, 0.043]],
        wheels: [0.248, 0.798, 0.069], cl: 0.042, rim: '10', caliper: '#c41a1a',
        wing: { x: 0.957, y: 0.233, len: 0.091, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.093], [0.07, 0.102], [0.078, 0.095], [0.014, 0.086]],
        tl: [[0.978, 0.162], [0.998, 0.158], [0.999, 0.143], [0.98, 0.146]],
        line: [[0.06, 0.11], [0.4, 0.116], [0.7, 0.118]],
      },
    },
    {
      id: 'lm55', brand: 'Mazda', name: 'LM55 Vision GT', price: 850000, top: 340, acc: 2.8, hand: 0.95, gears: 6,
      color: '#eef0f3', sec: '#1b1c1f', eng: { cyl: 4, idle: 1200, red: 9000, sub: 0.25, turbo: 0 },
      desc: 'El prototipo de Le Mans que Mazda soñó para Gran Turismo: ligero, blanco y afilado.',
      rear: { w: 1, h: 0.5, deck: 0.36, cabinB: 0.42, cabinT: 0.3, hip: 6, arch: 0, lights: 'bar', spoiler: 'bigwing', exhaust: 'center1', fins: 8, badge: 'wings', mesh: 1, engine: 0, fin: 1 },
      side: {
        body: [[0.012, 0.019], [0.0, 0.053], [0.008, 0.09], [0.039, 0.13], [0.102, 0.158], [0.164, 0.167], [0.227, 0.166], [0.289, 0.156], [0.352, 0.193], [0.414, 0.208], [0.477, 0.212], [0.539, 0.21], [0.602, 0.204], [0.664, 0.196], [0.727, 0.184], [0.789, 0.181], [0.852, 0.18], [0.914, 0.176], [0.977, 0.171], [0.992, 0.17], [1.0, 0.109], [0.99, 0.052]],
        glass: [[0.375, 0.188], [0.432, 0.199], [0.488, 0.202], [0.545, 0.199], [0.601, 0.194], [0.658, 0.187], [0.714, 0.177], [0.714, 0.158], [0.658, 0.158], [0.601, 0.158], [0.545, 0.158], [0.488, 0.158], [0.432, 0.157], [0.375, 0.154]],
        wheels: [0.195, 0.796, 0.0711], cl: 0.039, rim: '10', caliper: '#d6202a',
        wing: { x: 0.958, y: 0.214, len: 0.088, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.109], [0.07, 0.121], [0.078, 0.112], [0.014, 0.101]],
        tl: [[0.978, 0.161], [0.998, 0.158], [0.999, 0.142], [0.98, 0.146]],
        line: [[0.06, 0.125], [0.4, 0.131], [0.7, 0.134]], mirror: [0.395, 0.152],
      },
    },
    {
      id: 'm787b', brand: 'Mazda', name: '787B', price: 1300000, top: 340, acc: 3.0, hand: 0.9, gears: 5,
      color: '#f36f21', sec: '#12a36f', eng: { cyl: 4, idle: 1500, red: 9000, sub: 0.2, turbo: 0 },
      desc: 'El único motor rotativo que ha ganado Le Mans (1991): cuatro rotores y un grito inolvidable.',
      rear: { w: 1, h: 0.52, deck: 0.4, cabinB: 0.5, cabinT: 0.36, hip: 8, arch: 4, lights: 'round4', spoiler: 'bigwing', exhaust: 'center1', fins: 3, badge: 'wings', mesh: 1, engine: 1 },
      side: {
        body: [[0.012, 0.036], [0.0, 0.053], [0.008, 0.075], [0.039, 0.093], [0.102, 0.132], [0.164, 0.148], [0.227, 0.151], [0.289, 0.167], [0.352, 0.184], [0.414, 0.196], [0.477, 0.196], [0.539, 0.192], [0.602, 0.18], [0.664, 0.161], [0.727, 0.161], [0.789, 0.163], [0.852, 0.163], [0.914, 0.162], [0.977, 0.161], [0.992, 0.161], [1.0, 0.11], [0.99, 0.063]],
        glass: [[0.358, 0.175], [0.401, 0.184], [0.443, 0.186], [0.486, 0.185], [0.528, 0.182], [0.571, 0.175], [0.613, 0.165], [0.613, 0.143], [0.571, 0.142], [0.528, 0.141], [0.486, 0.14], [0.443, 0.139], [0.401, 0.137], [0.358, 0.135]],
        wheels: [0.217, 0.773, 0.0649], cl: 0.042, rim: 'aero', caliper: '#b8b8b8',
        wing: { x: 0.979, y: 0.229, len: 0.096, th: 0.012, post: 0.9, big: true },
        hl: [[0.006, 0.083], [0.07, 0.092], [0.078, 0.085], [0.014, 0.077]],
        tl: [[0.978, 0.151], [0.998, 0.147], [0.999, 0.133], [0.98, 0.136]],
        line: [[0.06, 0.115], [0.4, 0.121], [0.7, 0.124]], mirror: [0.378, 0.133],
      },
    },
  ];
  TG.CAR = {};
  ...
  // Rivales por copa: se añaden los coches nuevos por temática (los pools son índices de TG.CARS)
  const EXTRA_RIVALS = {
    usa: ['charger'], sam: ['delta', 'quattro'], jpn: ['i20wrc', 'polowrc', 'beetle'], ger: ['gt3rs', 'gt3r', 'huracanspy'],
    sca: ['gt3r992', 'f296', 'huracanst'], fra: ['f40', 'f296gt3', 'testarossa', 'clkgtr'], ita: ['sp3', 'lm55', 'gtp'],
    gbr: ['f499p', 'm787b', 'p917', 'bolide', 'devel'],
  };
  TG.CUPS.forEach((cup) => (EXTRA_RIVALS[cup.id] || []).forEach((id) => { if (TG.CAR[id]) cup.pool.push(TG.CAR[id].index); }));
